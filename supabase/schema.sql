...
-- Auto-create a stub profile the instant someone signs up, regardless of
-- whether email confirmation is required. This prevents accounts existing
-- in auth.users with no matching profiles row (the "stuck loading" bug).
